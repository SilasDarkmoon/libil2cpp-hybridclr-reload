...
DO_API(const Il2CppType*, il2cpp_class_enum_basetype, (Il2CppClassAdapter * klass));
...
DO_API(Il2CppClassAdapter*, il2cpp_class_from_il2cpp_type, (const Il2CppType * type));
...
DO_API(Il2CppClassAdapter*, il2cpp_class_from_type, (const Il2CppType * type));
DO_API(const Il2CppType*, il2cpp_class_get_type, (Il2CppClassAdapter * klass));
...
DO_API(const Il2CppImageAdapter*, il2cpp_class_get_image, (Il2CppClass * klass));
...
DO_API(Il2CppClassAdapter*, il2cpp_type_get_class_or_element_class, (const Il2CppType * type));
